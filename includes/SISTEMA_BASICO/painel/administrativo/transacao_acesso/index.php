...
if(!$bPermissaoVisualizar) {
	$sObjetoAcesso = "VERIFICAR: Usuário ".$_SESSION['oLoginAdm']->oUsuario->getNmUsuario()." tentou acessar o log de alertas do sistema, porém não possui permissão para isso!";
	...
	$sObjeto = "Usuário ".$_SESSION['oLoginAdm']->oUsuario->getNmUsuario()." acessou o log de alertas do sistema!";
...
<!-- InstanceBeginEditable name="EDITAVEL" -->
    ...
    <div id="MIGALHA"><a href="/painel/">Home</a> &gt; <a href="/painel/">Módulo Administrativo</a> &gt; <strong>Alertas</strong></div> 
    <h1>Alertas</h1> 
            ...
            <tr>
                ...
                <td colspan="2" class="Texto">
                    <select name="fIdUsuario" class="Campo">
                        ...
                        <option value="0" <?php echo (isset($_POST['fIdUsuario']) && $_POST['fIdUsuario'] == "0") ? "selected" : ""?>>SISTEMA</option>
                        <?php
    ...
    <?php
		if(isset($_POST['bPesquisar']) && $_POST['bPesquisar'] == 1){
			...
			$sWhereUsuario = "";
			if(isset($_POST['fIdUsuario']) && $_POST['fIdUsuario'] != "")
	...
	?>
        <tr<?php echo $sZebra?>>
            <td class="Texto"><?php echo (isset($oUsuario) && is_object($oUsuario)) ? $oUsuario->getNmUsuario() : "SISTEMA"?></td>

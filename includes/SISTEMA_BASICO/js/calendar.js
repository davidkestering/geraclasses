...
// $Id: calendar.js,v 1.3 2003/12/03 21:28:18 madbear Exp $
	...
	if (typeof el.navtype == "undefined") {
		...
		switch (el.navtype) {
			...
			if (typeof text != "undefined") {
				...
				text = "Calendário - Big Ben.\n\n\n" +					
					"Em caso de dúvida, envie um email para contato@bredi.com.br\n\n" +
					"Obrigado\n\n" +
					"Bredi Tecnologia Digital LTDA\n" +
					"http://www.bredi.com.br\n";
			}
			alert(text);
			return;
		    case -2:

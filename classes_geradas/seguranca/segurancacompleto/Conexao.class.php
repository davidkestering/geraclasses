...
class Conexao {
	...
	*/
	function Conexao($sServidor = 'BANCO') {
		...
		switch ($sServidor) {
			case 'LOCAL':
				$this->conectaBD("localhost","root","","leonardo");
			break;
			case 'BANCO':
				$this->conectaBD("localhost","root","","");
			break;
			default:
	...
	*/
	function conectaBD($sHost,$sUser,$sSenha,$sBanco) {
            ...
            mysqli_query($this->pConexao,'SET character_set_connection=utf8mb4');
            mysqli_query($this->pConexao,'SET character_set_client=utf8mb4');
            mysqli_query($this->pConexao,'SET character_set_results=utf8mb4');

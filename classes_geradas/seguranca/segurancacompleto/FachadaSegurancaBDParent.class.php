...
class FachadaSegurancaBDParent {
	...
	*/	
	function inicializaTransacao($nId,$nIdTipoTransacao,$nIdUsuario,$sObjeto,$sIp,$dDtCadastro,$bPublicado,$bAtivo) {
		$oTransacao = new Transacao($nId,$nIdTipoTransacao,$nIdUsuario,$sObjeto,$sIp,$dDtCadastro,$bPublicado,$bAtivo);
		return $oTransacao;
	}
	...
	*/	
	function inicializaTransacaoAcesso($nId,$nIdTipoTransacao,$nIdUsuario,$sObjeto,$sIp,$dDtCadastro,$bPublicado,$bAtivo) {
		$oTransacaoAcesso = new TransacaoAcesso($nId,$nIdTipoTransacao,$nIdUsuario,$sObjeto,$sIp,$dDtCadastro,$bPublicado,$bAtivo);

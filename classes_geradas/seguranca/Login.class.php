...
class Login {
	...
	function logarUsuarioPainel($sLogin,$sSenha,$sBanco){
		...
		$vWhereUsuario = array("login = '".utf8_decode($sLogin)."'","publicado = 1","ativo = 1","logado = 0");
		$voUsuario = $oFachadaSeguranca->recuperaTodosUsuario($sBanco,$vWhereUsuario);

		$vWhereUsuarioLogado = array("login = '".utf8_decode($sLogin)."'","publicado = 1","ativo = 1","logado = 1");
